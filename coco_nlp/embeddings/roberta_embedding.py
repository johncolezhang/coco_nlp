...
from coco_nlp.embeddings.transformer_embedding import TransformerEmbedding
...
class RoBertAEmbedding(TransformerEmbedding):
    ...
    def __init__(self,
        ...
        config_path = os.path.join(self.model_folder, 'roberta_config.json')
        checkpoint_path = os.path.join(self.model_folder, 'roberta_model.ckpt')

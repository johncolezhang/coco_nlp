...
def f1_score(y_true: List[List[str]],
    ...
    Returns:
        score : float.
    Example:
        >>> from coco_nlp.metrics.sequence_labeling import f1_score
...
def accuracy_score(y_true: List[List[str]], y_pred: List[List[str]]) -> float:
    ...
    Returns:
        score : float.
    Example:
        >>> from coco_nlp.metrics.sequence_labeling import accuracy_score
        >>> y_true = [['O', 'O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
...
def precision_score(y_true: List[List[str]],
    ...
    Returns:
        score : float.
    Example:
        >>> from coco_nlp.metrics.sequence_labeling import precision_score
        >>> y_true = [['O', 'O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
...
def recall_score(y_true: List[List[str]],
    ...
    Returns:
        score : float.
    Example:
        >>> from coco_nlp.metrics.sequence_labeling import recall_score
        >>> y_true = [['O', 'O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
...
def performance_measure(y_true: List[List[str]],
    ...
    Example:
        >>> from coco_nlp.metrics.sequence_labeling import performance_measure

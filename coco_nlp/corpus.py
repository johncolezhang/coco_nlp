...
from coco_nlp import macros as K
from coco_nlp import utils
from coco_nlp.logger import logger
from coco_nlp.tokenizers.base_tokenizer import Tokenizer
from coco_nlp.tokenizers.bert_tokenizer import BertTokenizer
...
class ChineseDailyNerCorpus:
    ...
    __zip_file__name = 'http://s3.bmio.net/coco_nlp/china-people-daily-ner-corpus.tar.gz'
...
class SMP2018ECDTCorpus:
    ...
    __zip_file__name = 'http://s3.bmio.net/coco_nlp/SMP2018ECDTCorpus.tar.gz'
...
if __name__ == "__main__":
    corpus = JigsawToxicCommentCorpus(
        '/Users/cole.zhang/Downloads/jigsaw-toxic-comment-classification-challenge/train.csv')
